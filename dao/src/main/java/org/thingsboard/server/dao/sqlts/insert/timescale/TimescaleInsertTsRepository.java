...
//    private static final String INSERT_OR_UPDATE =
//            "REPLACE INTO ts_kv (entity_id, `key`, ts, bool_v, str_v, long_v, dbl_v, json_v) VALUES(?, ?, ?, ?, ?, ?, ?, cast(? AS json));";
    private static final String INSERT_OR_UPDATE = "call ts_kv_insert_on_conflict_do_update(?,?,?,?,?,?,?,?)";

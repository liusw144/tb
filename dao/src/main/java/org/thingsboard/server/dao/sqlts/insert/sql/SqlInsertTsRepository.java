...
//    private static final String INSERT_ON_CONFLICT_DO_UPDATE = "REPLACE INTO ts_kv (entity_id, `key`, ts, bool_v, str_v, long_v, dbl_v, json_v) VALUES (?, ?, ?, ?, ?, ?, ?, cast(? AS json));";

    private static final String INSERT_ON_CONFLICT_DO_UPDATE="call ts_kv_insert_on_conflict_do_update(?,?,?,?,?,?,?,?)";
...
//              ps.setObject(1, tsKvEntity.getEntityId());
                ps.setString(1, tsKvEntity.getEntityId()+"");
